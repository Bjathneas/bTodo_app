...
namespace bTodo::frontend {
  ftxui::Component TodoMenu::createMenu() {
    ...
    this->information_container = ftxui::Container::Vertical(
      {bTodo::frontend::components::Window("Info", ftxui::Scroller({bTodo::frontend::components::PhantomComponent(ftxui::vbox({
  ...
  void TodoMenu::setDisplayedTaskInfo(std::string &info, std::string &date) {
    ...
    this->information_container->Add(bTodo::frontend::components::Window("Info", ftxui::Scroller({bTodo::frontend::components::PhantomComponent(ftxui::vbox({
                                                                        ftxui::paragraph(info),
                                                                        ftxui::separator(),
  ...
  bool TodoMenu::hasTaskSelectedChanged() {
    ...
    if(has_changed)
      this->task_selected_previously = this->task_selected;
